    ...
    <div class="flex items-center gap-3">
        <?php if ($unreadCount > 0): ?>
            <form method="POST">
                ...
                <button type="submit" class="px-5 h-10 inline-flex items-center justify-center text-sm rounded-lg border border-slate-200 dark:border-slate-800 text-slate-600 dark:text-slate-400 hover:bg-slate-100 dark:hover:bg-slate-800 transition-colors font-medium text-sm flex items-center gap-2">
