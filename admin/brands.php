    ...
    <div class="admin-card max-w-2xl mx-auto">
        ...
        <form method="POST" enctype="multipart/form-data" class="space-y-6">
            ...
            <div class="flex items-center gap-3 pt-4">
                ...
                <a href="brands.php" class="px-6 h-10 inline-flex items-center justify-center text-sm rounded-lg border border-slate-200 dark:border-slate-800 text-slate-600 dark:text-slate-400 hover:bg-slate-100 dark:hover:bg-slate-800 transition-colors font-medium text-center">انصراف</a>
            </div>
        </form>
    </div>
<?php endif; ?>
